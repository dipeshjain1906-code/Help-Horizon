...
```sh
git clone https://github.com/dipeshjain1906-code/Help-Horizon.git
```
...
```sh
git remote add upstream https://github.com/dipeshjain1906-code/Help-Horizon.git
```
...
origin	https://github.com/Your_Username/help-horizon.git (fetch)
origin	https://github.com/Your_Username/help-horizon.git (push)
upstream	https://github.com/dipeshjain1906-code/Help-Horizon (fetch)
upstream	https://github.com/dipeshjain1906-code/Help-Horizon (push)
```
